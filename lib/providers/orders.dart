...
Future<void> fetchAndSetOrders()async{
  ...
  final url=
      "https://shop-bdcea-default-rtdb.firebaseio.com/ordrs/$userId.json?auth=$authToken";
...
Future<void> addOrder (List<CartItem> cartProduct,double total)async{
  final url=
      "https://shop-bdcea-default-rtdb.firebaseio.com/orders/$userId.json?auth=$authToken";
